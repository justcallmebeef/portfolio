...
const Contact = (props) => {
    return (
        <Fragment>
            ...
            <a href= "mailto:your_email" rel="noopener noreferrer"><i id="bigIcon" className="fa fa-envelope"></i></a><a href= "mailto:your_email" rel="noopener noreferrer"><p>bethanymitch10@gmail.com</p></a>
