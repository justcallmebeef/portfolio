    ...
    return (
        <Fragment>
            ...
            <ul className={`${props.toggleMenu ? 'mainNav' : 'mainNav-none' }`}>
                <li className="active"><Link to='/' style={{ textDecoration: 'none', color: '#008080' }}>Home</Link></li>
                <li><Link to='/projects' style={{ textDecoration: 'none', color: '#008080' }}>Projects</Link></li>
            ...
            <p className="homeP">Hi! I'm Bethany - a Full-Stack Web Developer.</p>
            </div>
        </Fragment>
    )
}
